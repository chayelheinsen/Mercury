...
protocol MercuryNotificationDelegate: class {
    func notificationDidChangeAutoClose(notification: MercuryNotification)
}

public class MercuryNotification: NSObject {
    weak var delegate: MercuryNotificationDelegate?
    ...
    public var action: ((MercuryNotification) -> Void)? = nil
    ...
    /// Any extra information you would like to put in the notification.
