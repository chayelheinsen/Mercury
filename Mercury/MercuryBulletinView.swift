...
protocol MercuryBulletinViewDelegate: class {
...
let kNotificationHeight: CGFloat = 60

class MercuryBulletinView: UIView, UIScrollViewDelegate, MercuryNotificationDelegate {
    weak var delegate: MercuryBulletinViewDelegate?
    ...
    var notifications = [MercuryNotification]() {
        didSet {
    ...
    func layoutNotifications() {
        ...
        for (i, notification) in notifications.enumerate() {
            ...
            if notificationView == nil {
                notificationView = MercuryDefaultNotificationView()
            }
    ...
    // MARK: - MercuryNotificationDelegate
    func notificationDidChangeAutoClose(notification: MercuryNotification) {
